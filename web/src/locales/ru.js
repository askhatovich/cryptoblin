export const ru = {
    app: {
        ...
        privacy_blurb: 'Сквозное шифрование XChaCha20-Poly1305 с производным ключом Argon2id. Ключ генерируется в браузере отправителя и передаётся в якоре URL, который никогда не передаётся на сервер. На сервере хранится только шифротекст; прочитать содержимое записи сервер не может.'
    },
    nav: {
